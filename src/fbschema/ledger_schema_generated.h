...
#ifndef FLATBUFFERS_GENERATED_LEDGERSCHEMA_FBSCHEMA_CONS_H_
#define FLATBUFFERS_GENERATED_LEDGERSCHEMA_FBSCHEMA_CONS_H_
...
inline flatbuffers::Offset<Ledger> CreateLedgerDirect(
  ...
  return fbschema::cons::CreateLedger(
      _fbb,
      time,
      lcl__,
      users__,
...
inline flatbuffers::Offset<RawInputList> CreateRawInputListDirect(
  ...
  return fbschema::cons::CreateRawInputList(
      _fbb,
      hash__,
      inputs__);
}

inline const fbschema::cons::Ledger *GetLedger(const void *buf) {
  return flatbuffers::GetRoot<fbschema::cons::Ledger>(buf);
}

inline const fbschema::cons::Ledger *GetSizePrefixedLedger(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<fbschema::cons::Ledger>(buf);
}
...
inline bool VerifyLedgerBuffer(
  ...
  return verifier.VerifyBuffer<fbschema::cons::Ledger>(nullptr);
}

inline bool VerifySizePrefixedLedgerBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fbschema::cons::Ledger>(nullptr);
}

inline void FinishLedgerBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<fbschema::cons::Ledger> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_LEDGERSCHEMA_FBSCHEMA_CONS_H_
