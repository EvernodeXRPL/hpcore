...
namespace comm
{
    ...
    constexpr uint16_t MAX_IN_MSG_QUEUE_SIZE = 254;        // Maximum in message queue size, The size passed is rounded to next number in binary sequence 1(1),11(3),111(7),1111(15),11111(31)....
