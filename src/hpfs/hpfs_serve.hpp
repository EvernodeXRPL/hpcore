...
namespace hpfs
{
    ...
    private:
        ...
        void generate_hint_responses(std::vector<flatbuffers::FlatBufferBuilder> &fbuf_vec, std::string_view parent_path, const std::vector<p2p::hpfs_fs_hash_entry> &fs_entries);
