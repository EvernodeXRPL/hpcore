...
void on_user_message(const struct hotpocket_user *user, const void *buf, const size_t len);
void on_peer_message(const char *peerPubKey, const void *buf, const size_t len);
